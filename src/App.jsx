...
export default function App() {
  ...
  const togglePlace = (id) => {
    setForm((current) => {
      ...
      // Musical Show is fixed to 22 August 2026 after 6 PM
  ...
  const selectedPlaceNames = form.places
    .map(
      (id) =>
        PLACE_OPTIONS.find((place) => place.id === id)?.label
    )
    .join(", ");
  ...
  const selectedFoodNames = form.food
    .map(
      (id) =>
        FOOD_OPTIONS.find((food) => food.id === id)?.label
    )
    .join(", ");
                ...
                <div className="flex flex-col gap-5 flex-1">
                  ...
                  <div className="rounded-xl bg-white border-2 border-[#0E7C7B]/20 p-4">
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-lg border-2 border-[#0E7C7B]/20 px-3 py-2 text-[#0B4F4A] bg-white outline-none focus:border-[#0E7C7B] disabled:bg-gray-100"
                    />
                ...
                <div className="flex flex-col gap-5 flex-1">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    <button
                      ...
                      className={`rounded-xl py-4 px-4 font-bold border-2 flex items-center justify-center gap-2 transition ${
                    ...
                    <button
                      ...
                      className={`rounded-xl py-4 px-4 font-bold border-2 transition ${
                        form.payment === "free"
